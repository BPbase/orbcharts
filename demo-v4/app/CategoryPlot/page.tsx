...
import { CategoryPlot, Tooltip, Legend } from '@orbcharts/plugin-basic'
...
export default function CategoryPlotPage() {
  ...
  useEffect(() => {
    ...
    const categoryPlot = new CategoryPlot({
      RaisedBubbles: {
        // bubble: {
        //   sizeAdjust: 0.8,
        //   arcScaleType: 'area',
    ...
    const chart = new OrbCharts(domRef.current!, {
      ...
      plugins: [categoryPlot, tooltip, legend]
    })
