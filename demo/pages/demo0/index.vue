...
import { GroupAxis, ValueAxis, Bars, GridZoom, Tooltip, GridLegend } from '../../../packages/orbcharts-plugins-basic/src'
...
onMounted(() => {
  ...
  chart!.plugins$.next([ new GroupAxis(), new ValueAxis(), new Bars(), new GridZoom(), new Tooltip(), new GridLegend() ])
