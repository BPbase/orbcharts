...
import { GroupAxis, ValueAxis, Bars, GroupZoom, GridTooltip, GridLegend } from '../../../packages/orbcharts-plugins-basic/src'
...
onMounted(() => {
  ...
  chart!.plugins$.next([ new GroupAxis(), new ValueAxis(), new Bars(), new GroupZoom(), new GridTooltip(), new GridLegend() ])
