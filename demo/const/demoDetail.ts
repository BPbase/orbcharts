  ...
  grid: {
    'Bars': {
      'PRESET_GRID_BASIC': {
        ...
        plugins: [pluginsBasic.Bars, pluginsBasic.GroupAxis, pluginsBasic.ValueAxis, pluginsBasic.GridLegend, pluginsBasic.Tooltip as any],
    ...
    'BarStack': {
      'PRESET_GRID_BASIC': {
        chart: core.GridChart,
        plugins: [pluginsBasic.BarStack, pluginsBasic.GroupAxis, pluginsBasic.ValueStackAxis, pluginsBasic.GridLegend, pluginsBasic.Tooltip as any],
        preset: presetsBasic.PRESET_GRID_BASIC,
        data: gridData1
      },
      'PRESET_GRID_ROTATE_AXIS_LABEL': {
    ...
    'BarsTriangle': {
      'PRESET_GRID_BASIC': {
        chart: core.GridChart,
        plugins: [pluginsBasic.BarsTriangle, pluginsBasic.GroupAxis, pluginsBasic.ValueAxis, pluginsBasic.GridLegend, pluginsBasic.Tooltip as any],
        preset: presetsBasic.PRESET_GRID_BASIC,
        data: gridData1
      },
      'PRESET_GRID_ROTATE_AXIS_LABEL': {
    ...
    'Lines': {
      'PRESET_GRID_BASIC': {
        chart: core.GridChart,
        plugins: [pluginsBasic.Lines, pluginsBasic.GroupAxis, pluginsBasic.ValueAxis, pluginsBasic.GroupArea, pluginsBasic.Dots, pluginsBasic.GridLegend, pluginsBasic.Tooltip as any],
        preset: presetsBasic.PRESET_GRID_BASIC,
        data: gridData1
      },
      'PRESET_GRID_ROTATE_AXIS_LABEL': {
