...
import type { GridSeparableGraphicPluginParams, StackedBarsParams } from '../types'
...
export const StackedBars = defineSVGLayer<GridSeparableGraphicExtendContext, GridSeparableGraphicPluginParams, StackedBarsParams>({
  name: layerName,
