...
import type { CategoryZoomParams, GridSeparableGraphicPluginParams } from '../types'
...
export const CategoryZoom = defineSVGLayer<GridSeparableGraphicExtendContext, GridSeparableGraphicPluginParams, CategoryZoomParams>({
  name: layerName,
