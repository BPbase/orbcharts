...
import type { BarsTriangleParams, GridSeparableGraphicPluginParams } from '../types'
...
export const BarsTriangle = defineSVGLayer<GridSeparableGraphicExtendContext, GridSeparableGraphicPluginParams, BarsTriangleParams>({
  name: layerName,
