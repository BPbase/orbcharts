...
import type { BarsParams, GridSeparableGraphicPluginParams } from '../types'
...
export const Bars = defineSVGLayer<GridSeparableGraphicExtendContext, GridSeparableGraphicPluginParams, BarsParams>({
  name: layerName,
