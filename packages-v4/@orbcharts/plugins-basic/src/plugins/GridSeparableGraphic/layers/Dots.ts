...
import type { DotsParams, GridSeparableGraphicPluginParams } from '../types'
...
export const Dots = defineSVGLayer<GridSeparableGraphicExtendContext, GridSeparableGraphicPluginParams, DotsParams>({
  name: layerName,
