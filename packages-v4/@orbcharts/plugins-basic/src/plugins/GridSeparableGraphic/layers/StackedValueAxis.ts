...
import type { StackedValueAxisParams, GridSeparableGraphicPluginParams } from '../types'
...
export const StackedValueAxis = defineSVGLayer<GridSeparableGraphicExtendContext, GridSeparableGraphicPluginParams, StackedValueAxisParams>({
  name: layerName,
