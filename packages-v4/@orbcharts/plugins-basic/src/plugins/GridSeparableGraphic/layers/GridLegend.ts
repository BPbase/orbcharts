...
import type { GridLegendParams, GridSeparableGraphicPluginParams } from '../types'
...
export const GridLegend = defineSVGLayer<GridSeparableGraphicExtendContext, GridSeparableGraphicPluginParams, GridLegendParams>({
  name: layerName,
