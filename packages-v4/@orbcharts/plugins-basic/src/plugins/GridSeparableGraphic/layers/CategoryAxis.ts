...
import type { CategoryAxisParams, GridSeparableGraphicPluginParams } from '../types'
...
export const CategoryAxis = defineSVGLayer<GridSeparableGraphicExtendContext, GridSeparableGraphicPluginParams, CategoryAxisParams>({
  name: layerName,
