...
import type { LineAreasParams, GridSeparableGraphicPluginParams } from '../types'
...
export const LineAreas = defineSVGLayer<GridSeparableGraphicExtendContext, GridSeparableGraphicPluginParams, LineAreasParams>({
  name: layerName,
