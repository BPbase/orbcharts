...
import type { CategoryAuxParams, GridSeparableGraphicPluginParams } from '../types'
...
import { gridSelectionsObservable, gridCategoryPositionObservable } from '../sharedObservables'
...
function renderLabel ({ selection, labelData, pluginParams, layerParams, theme, textReverseTransformWithRotate, fontSizePx }: {
  ...
  pluginParams: GridSeparableGraphicPluginParams
  layerParams: CategoryAuxParams
  theme: Theme
...
export const CategoryAux = defineSVGLayer<GridSeparableGraphicExtendContext, GridSeparableGraphicPluginParams, CategoryAuxParams>({
  name: layerName,
