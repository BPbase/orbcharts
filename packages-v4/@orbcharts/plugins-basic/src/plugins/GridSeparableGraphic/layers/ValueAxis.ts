...
import type { ValueAxisParams, GridSeparableGraphicPluginParams } from '../types'
...
export const ValueAxis = defineSVGLayer<GridSeparableGraphicExtendContext, GridSeparableGraphicPluginParams, ValueAxisParams>({
  name: layerName,
