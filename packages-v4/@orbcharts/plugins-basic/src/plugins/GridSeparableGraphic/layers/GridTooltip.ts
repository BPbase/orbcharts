...
import type { GridTooltipParams, GridSeparableGraphicPluginParams } from '../types'
...
export const GridTooltip = defineSVGLayer<GridSeparableGraphicExtendContext, GridSeparableGraphicPluginParams, GridTooltipParams>({
  name: layerName,
