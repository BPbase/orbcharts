...
import type { SeriesSeparableGraphicExtendContext, SeriesSeparableGraphicPluginParams, PieEventTextsParams } from "../types"
...
export const PieEventTexts = defineSVGLayer<SeriesSeparableGraphicExtendContext, SeriesSeparableGraphicPluginParams, PieEventTextsParams>({
  name: layerName,
