...
import {
  ...
  first,
  iif} from 'rxjs'
import type { DefinePluginConfig, Theme } from '../../../../../core/src/types'
import type { SeriesSeparableGraphicExtendContext, SeriesSeparableGraphicPluginParams, BubblesParams } from "../types"
...
function highlight ({ bubblesSelection, highlightIds, pluginParams }: {
  ...
  pluginParams: SeriesSeparableGraphicPluginParams
  highlightIds: string[]
}) {
...
export const Bubbles = defineSVGLayer<SeriesSeparableGraphicExtendContext, SeriesSeparableGraphicPluginParams, BubblesParams>({
  name: layerName,
