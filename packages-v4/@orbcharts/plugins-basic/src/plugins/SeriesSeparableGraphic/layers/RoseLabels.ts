...
import type { SeriesSeparableGraphicExtendContext, SeriesSeparableGraphicPluginParams, RoseParams, RoseLabelsParams } from "../types"
...
export const RoseLabels = defineSVGLayer<SeriesSeparableGraphicExtendContext, SeriesSeparableGraphicPluginParams, RoseLabelsParams>({
  name: layerName,
