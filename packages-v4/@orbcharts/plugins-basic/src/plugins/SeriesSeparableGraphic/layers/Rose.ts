...
import type { SeriesSeparableGraphicExtendContext, SeriesSeparableGraphicPluginParams, RoseParams } from "../types"
...
export const Rose = defineSVGLayer<SeriesSeparableGraphicExtendContext, SeriesSeparableGraphicPluginParams, RoseParams>({
  name: layerName,
