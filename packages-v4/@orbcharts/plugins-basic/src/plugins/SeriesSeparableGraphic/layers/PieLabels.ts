...
import type { SeriesSeparableGraphicExtendContext, SeriesSeparableGraphicPluginParams, PieLabelsParams } from "../types"
...
export const PieLabels = defineSVGLayer<SeriesSeparableGraphicExtendContext, SeriesSeparableGraphicPluginParams, PieLabelsParams>({
  name: layerName,
