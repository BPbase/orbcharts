...
import type { SeriesLegendExtendContext, SeriesLegendPluginParams, SeriesLegendParams } from "../types"
...
const layerName = 'SeriesLegend'

export const SeriesLegend = defineSVGLayer<SeriesLegendExtendContext, SeriesLegendPluginParams, SeriesLegendParams>({
  name: layerName,
