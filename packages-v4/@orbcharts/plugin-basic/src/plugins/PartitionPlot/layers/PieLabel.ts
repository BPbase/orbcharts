...
import type { PartitionPlotExtendContext, PartitionPlotPluginParams, PartitionPlotPieLabelParams } from "../types"
import type { PieDatum } from '../utils'
import { defineSVGLayer } from '@orbcharts/core'
import { validateObject } from '@orbcharts/core'
import { DEFAULT_PARTITION_PLOT_PIE_LABEL_PARAMS } from "../defaults"
...
function makeRenderData ({ pieData, arc, arcMouseover, labelCentroid, lineStartCentroid, layerParams }: {
  ...
  layerParams: PartitionPlotPieLabelParams
}): RenderDatum[] {
  return pieData
    .map((d, i) => {
...
function createEachPieLabel (context: {
  ...
  layerParams$: Observable<PartitionPlotPieLabelParams>
...
export const PieLabel = defineSVGLayer<PartitionPlotExtendContext, PartitionPlotPluginParams, PartitionPlotPieLabelParams>({
  name: layerName,
  defaultParams: DEFAULT_PARTITION_PLOT_PIE_LABEL_PARAMS,
