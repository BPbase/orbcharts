...
import type { PartitionPlotExtendContext, PartitionPlotPluginParams, PartitionPlotRoseLabelParams } from "../types"
import type { PieDatum } from '../utils'
import { defineSVGLayer } from '@orbcharts/core'
import { validateObject } from '@orbcharts/core'
import { DEFAULT_PARTITION_PLOT_ROSE_LABEL_PARAMS, DEFAULT_ROSE_PARAMS } from "../defaults"
...
function makeRenderData ({ pieData, labelCentroid, arcScaleType, maxValue, axisWidth, outerRadius, lineStartCentroid, layerParams }: {
  ...
  layerParams: PartitionPlotRoseLabelParams
}): RenderDatum[] {
...
function createEachPieLabel (context: {
  ...
  layerParams$: Observable<PartitionPlotRoseLabelParams>
...
export const RoseLabel = defineSVGLayer<PartitionPlotExtendContext, PartitionPlotPluginParams, PartitionPlotRoseLabelParams>({
  name: layerName,
  defaultParams: DEFAULT_PARTITION_PLOT_ROSE_LABEL_PARAMS,
