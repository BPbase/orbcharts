...
import type { PartitionPlotExtendContext, PartitionPlotPluginParams, PartitionPlotBubbleParams } from "../types"
import { defineSVGLayer } from '@orbcharts/core'
import { validateObject } from '@orbcharts/core'
import { DEFAULT_PARTITION_PLOT_BUBBLE_PARAMS } from "../defaults"
...
function createSimulation (bubblesSelection: d3.Selection<SVGGElement, BubblesDatum, any, any>, fullParams: PartitionPlotBubbleParams) {
...
//   fullParams: PartitionPlotBubbleParams
//   graphicWidth: number
...
export const Bubble = defineSVGLayer<PartitionPlotExtendContext, PartitionPlotPluginParams, PartitionPlotBubbleParams>({
  name: layerName,
  defaultParams: DEFAULT_PARTITION_PLOT_BUBBLE_PARAMS,
