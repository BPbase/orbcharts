...
import type { PartitionPlotExtendContext, PartitionPlotPluginParams, PartitionPlotPieEventTextParams } from "../types"
import type { PieDatum } from '../utils'
import { defineSVGLayer } from '@orbcharts/core'
import { validateObject } from '@orbcharts/core'
import { DEFAULT_PARTITION_PLOT_PIE_EVENT_TEXT_PARAMS } from "../defaults"
...
function createEachPieEventTexts (context: {
  ...
  layerParams$: Observable<PartitionPlotPieEventTextParams>
...
export const PieEventText = defineSVGLayer<PartitionPlotExtendContext, PartitionPlotPluginParams, PartitionPlotPieEventTextParams>({
  name: layerName,
  defaultParams: DEFAULT_PARTITION_PLOT_PIE_EVENT_TEXT_PARAMS,
