...
import type { PartitionPlotPluginParams } from './types'
...
export const separateSeriesObservable = ({ pluginParams$ }: { pluginParams$: Observable<PartitionPlotPluginParams> }) => {
...
export const separateNameObservable = ({ pluginParams$ }: { pluginParams$: Observable<PartitionPlotPluginParams> }) => {
  return pluginParams$.pipe(
...
// export const sumSeriesObservable = ({ pluginParams$ }: { pluginParams$: Observable<PartitionPlotPluginParams> }) => {
//   return pluginParams$.pipe(
