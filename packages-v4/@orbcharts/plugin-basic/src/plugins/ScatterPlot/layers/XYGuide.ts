...
import type { ScatterPlotPluginParams, ScatterPlotExtendContext, ScatterPlotXYGuideParams, ComputedXYDataMultivariate } from '../types'
import { defineSVGLayer } from '@orbcharts/core'
import { validateObject } from '@orbcharts/core'
import { DEFAULT_SCATTER_PLOT_X_Y_GUIDE_PARAMS } from "../defaults"
...
function createLineData ({ axisX, axisY, layout, layerParams }: {
  ...
  axisY: number
  layout: Layout
  layerParams: ScatterPlotXYGuideParams
}): LineDatum[] {
...
export const XYGuide = defineSVGLayer<ScatterPlotExtendContext, ScatterPlotPluginParams, ScatterPlotXYGuideParams>({
  name: layerName,
