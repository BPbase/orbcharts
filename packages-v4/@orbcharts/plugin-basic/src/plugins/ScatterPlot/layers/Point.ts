...
import type { ScatterPlotPluginParams, ScatterPlotExtendContext, ScatterPlotPointParams, ComputedXYDataMultivariate } from '../types'
import { defineSVGLayer } from '@orbcharts/core'
import { validateObject } from '@orbcharts/core'
import { DEFAULT_SCATTER_PLOT_POINT_PARAMS } from "../defaults"
...
function renderDots ({ graphicGSelection, circleGClassName, circleClassName, visibleComputedXYData, layerParams, styles, theme, graphicReverseScale }: {
  ...
  layerParams: ScatterPlotPointParams
...
export const Point = defineSVGLayer<ScatterPlotExtendContext, ScatterPlotPluginParams, ScatterPlotPointParams>({
  name: layerName,
  defaultParams: DEFAULT_SCATTER_PLOT_POINT_PARAMS,
