...
import type { ScatterPlotPluginParams, ScatterPlotExtendContext, ScatterPlotBubbleParams, ComputedXYDataMultivariate, ComputedXYDatumMultivariate } from '../types'
import { defineSVGLayer } from '@orbcharts/core'
import { validateObject } from '@orbcharts/core'
import { DEFAULT_SCATTER_PLOT_BUBBLE_PARAMS } from "../defaults"
...
function renderDots ({ graphicGSelection, circleGClassName, circleClassName, bubbleData, layerParams, styles, theme, graphicReverseScale }: {
  ...
  layerParams: ScatterPlotBubbleParams
...
export const Bubble = defineSVGLayer<ScatterPlotExtendContext, ScatterPlotPluginParams, ScatterPlotBubbleParams>({
  name: layerName,
  defaultParams: DEFAULT_SCATTER_PLOT_BUBBLE_PARAMS,
