...
import type { RacingValueLabelsParams, RacingPlotPluginParams } from '../types'
import { DEFAULT_RACING_VALUE_LABELS_PARAMS } from '../defaults'
import { LAYER_INDEX_OF_LABEL } from '../../../const/layerIndex'
import { defineSVGLayer } from '@orbcharts/core'
import type { RacingPlotExtendContext } from '../types'
import { createBaseRacingValueLabels } from '../../../baseLayers/BaseRacingValueLabels'

const pluginName = 'RacingPlot'
const layerName = 'RacingValueLabels'

export const RacingValueLabels = defineSVGLayer<RacingPlotExtendContext, RacingPlotPluginParams, RacingValueLabelsParams>({
  name: layerName,
  defaultParams: DEFAULT_RACING_VALUE_LABELS_PARAMS,
  ...
  setup: ({ svgG, pluginParams$, layerParams$, context }) => {
    ...
    const unsubscribe = createBaseRacingValueLabels({
