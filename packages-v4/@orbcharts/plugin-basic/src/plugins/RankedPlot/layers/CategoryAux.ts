...
import type { RankedCategoryAuxParams, RankedPlotPluginParams } from '../types'
import { DEFAULT_RANKED_CATEGORY_AUX_PARAMS } from '../defaults'
...
export const CategoryAux = defineSVGLayer<RankedPlotExtendContext, RankedPlotPluginParams, RankedCategoryAuxParams>({
  name: layerName,
  defaultParams: DEFAULT_RANKED_CATEGORY_AUX_PARAMS,
