...
export type CategoryPlotPosition = 'left' | 'right'

// ---- context ----

export interface CategoryPlotExtendContext {
...
// ---- category axis (no position field — position comes from CategoryPlotPluginParams) ----

export interface CategoryPlotCategoryAxis {
...
export interface CategoryPlotPluginParams {
  styles: GraphicStyles
  visibleFilter: VisibleFilter<'series'>
  position: CategoryPlotPosition
  categoryAxis: CategoryPlotCategoryAxis
  valueAxis: ValueAxis
  datasetIndex: number
}
...
export interface CategoryPlotAllLayerParams {
  RaisedBubbles: RaisedBubblesParams
  CategoryAxis: CategoryPlotCategoryAxisParams
  CategoryZoom: CategoryZoomParams
  ValueAxis: CategoryPlotValueAxisParams
  CategoryAux: CategoryAuxParams
}

// ---- layer params ----

export interface RaisedBubblesParams {
  bubble: {
    sizeAdjust: number
...
export interface CategoryPlotCategoryAxisParams {
...
export interface CategoryPlotValueAxisParams {
  labelOffset: [number, number]
  labelColorType: ColorType
  axisLineVisible: boolean
  axisLineColorType: ColorType
