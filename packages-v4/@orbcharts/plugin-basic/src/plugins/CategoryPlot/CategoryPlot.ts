...
import type { CategoryPlotExtendContext, CategoryPlotPluginParams, CategoryPlotAllLayerParams } from './types'
import { defineSVGPlugin, validateObject } from '@orbcharts/core'
import { DEFAULT_CATEGORY_PLOT_PARAMS } from './defaults'
...
import { RaisedBubbles } from './layers/RaisedBubbles'
...
const raisedBubbles = new RaisedBubbles()
const categoryAxis = new CategoryAxis()
const categoryZoom = new CategoryZoom()
const valueAxis = new ValueAxis()

export const CategoryPlot = defineSVGPlugin<
  CategoryPlotExtendContext,
  CategoryPlotPluginParams,
  CategoryPlotAllLayerParams
>({
  name: 'CategoryPlot',
  defaultParams: DEFAULT_CATEGORY_PLOT_PARAMS,
  layers: [categoryAxis, categoryZoom, raisedBubbles, valueAxis],
  setup: (props) => {
    ...
    const extendsContext: CategoryPlotExtendContext = {
      layout$,
      computedData$,
      fontSizePx$,
      containerSize$,
  ...
  validator: (params: CategoryPlotPluginParams) => {
