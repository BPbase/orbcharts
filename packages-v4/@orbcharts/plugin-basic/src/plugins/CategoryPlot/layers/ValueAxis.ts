...
import type { CategoryPlotValueAxisParams, CategoryPlotPluginParams } from '../types'
import { DEFAULT_CATEGORY_PLOT_VALUE_AXIS_PARAMS } from '../defaults'
...
export const ValueAxis = defineSVGLayer<CategoryPlotExtendContext, CategoryPlotPluginParams, CategoryPlotValueAxisParams>({
  name: layerName,
  defaultParams: DEFAULT_CATEGORY_PLOT_VALUE_AXIS_PARAMS,
