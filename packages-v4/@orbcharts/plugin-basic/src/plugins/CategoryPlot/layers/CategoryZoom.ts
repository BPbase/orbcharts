...
import type { CategoryZoomParams, CategoryPlotPluginParams } from '../types'
...
export const CategoryZoom = defineSVGLayer<CategoryPlotExtendContext, CategoryPlotPluginParams, CategoryZoomParams>({
  name: layerName,
