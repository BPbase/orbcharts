...
import type { CategoryAuxParams, CategoryPlotPluginParams } from '../types'
...
export const CategoryAux = defineSVGLayer<CategoryPlotExtendContext, CategoryPlotPluginParams, CategoryAuxParams>({
  name: layerName,
