...
import type { CategoryPlotCategoryAxisParams, CategoryPlotPluginParams } from '../types'
import { DEFAULT_CATEGORY_PLOT_CATEGORY_AXIS_PARAMS } from '../defaults'
...
export const CategoryAxis = defineSVGLayer<CategoryPlotExtendContext, CategoryPlotPluginParams, CategoryPlotCategoryAxisParams>({
  name: layerName,
  defaultParams: DEFAULT_CATEGORY_PLOT_CATEGORY_AXIS_PARAMS,
