...
import type { CategoricalPlotPluginParams, CategoricalPlotCategoryAxis, CategoricalPlotPosition } from './types'
...
export const seriesComputedDataObservable = ({
  ...
  pluginParams$: Observable<CategoricalPlotPluginParams>
...
// CategoricalPlot always uses a single container (no separateSeries)
...
export const categoryScaleDomainValueObservable = ({
  ...
  computedData$: Observable<ComputedDatumSeries[][]>
  categoryAxis$: Observable<CategoricalPlotCategoryAxis>
...
export const ordinalScaleObservable = ({
  ...
  position$: Observable<CategoricalPlotPosition>
...
// categoryAxis='bottom' + valueAxis='left'|'right', same rotateX(180) flip as GridPlot
