...
import type { RankedSeriesAxisParams } from '../plugins/RankedPlot/types'
...
function renderAxisLabel ({
  ...
  axisLabel: string
  fullParams: RankedSeriesAxisParams
...
export function createBaseRankedSeriesAxis ({
  selection,
  pluginName,
  layerName,
  rankedSeriesData$,
