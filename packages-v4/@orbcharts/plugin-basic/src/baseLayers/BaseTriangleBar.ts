...
export interface BaseTriangleBarParams {
    barWidth: number;
    barPadding: number;
...
interface BaseTriangleBarContext {
  ...
  baseBarsTriangleParams$: Observable<BaseTriangleBarParams>
...
function makeBarScale (barWidth: number, seriesLabels: string[], params: BaseTriangleBarParams) {
...
export const createBaseTriangleBar: BaseLayerFn<BaseTriangleBarContext> = ({
  selection,
  pluginName,
  layerName,
  computedData$,
