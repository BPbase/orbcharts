...
import type { RacingPlotSeriesLabelParams } from '../plugins/RacingPlot/types'
...
export interface BaseRacingSeriesLabelContext {
  ...
  fullParams$: Observable<RacingPlotSeriesLabelParams>
...
function renderAxisLabel ({
  ...
  axisLabel: string
  fullParams: RacingPlotSeriesLabelParams
...
export function createBaseRacingSeriesLabel ({
  selection,
  pluginName,
  layerName,
