...
import type { RaisedBubblesParams } from '../plugins/CategoryPlot/types'
...
export interface BaseRaisedBubblesContext {
  selection: d3.Selection<any, unknown, any, unknown>
  pluginName: string
  layerName: string
  computedData$: Observable<ComputedDatumSeries[][]>
  visibleComputedData$: Observable<ComputedDatumSeries[][]>
  fullParams$: Observable<RaisedBubblesParams>
...
export function createBaseRaisedBubbles ({
  selection,
  pluginName,
  layerName,
  computedData$,
