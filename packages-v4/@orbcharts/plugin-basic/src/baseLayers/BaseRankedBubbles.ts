...
import type { RankedBubblesParams } from '../plugins/RankedPlot/types'
...
export interface BaseRankedBubblesContext {
  ...
  fullParams$: Observable<RankedBubblesParams>
...
export function createBaseRankedBubbles ({
  selection,
  pluginName,
  layerName,
  computedData$,
