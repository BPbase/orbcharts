...
export interface BaseBarParams {
    barWidth: number;
    barPadding: number;
...
interface BaseBarContext {
  ...
  baseBarParams$: Observable<BaseBarParams>
...
function makeBarScale (barWidth: number, seriesLabels: string[], params: BaseBarParams) {
...
export const createBaseBar: BaseLayerFn<BaseBarContext> = ({
  selection,
  pluginName,
  layerName,
  computedData$,
